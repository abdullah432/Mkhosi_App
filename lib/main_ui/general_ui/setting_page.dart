...
class SettingPage extends StatefulWidget {
  final bool isNavigateFromServiceProvider;
  SettingPage({
    @required this.isNavigateFromServiceProvider,
    Key key,
  }) : super(key: key);

  @override
  _SettingPageState createState() =>
      _SettingPageState(isNavigateFromServiceProvider);
}
...
class _SettingPageState extends State<SettingPage>
  ...
  bool isNavigateFromServiceProvider;
  ...
  void initState() {
    listOfSettingItems = [
      ...
      SettingItem(
          title: isNavigateFromServiceProvider
              ? 'Report a Client'
              ...
              child: Visibility(
                ...
                child: Form(
                  ...
                  child: ReportPopup(
                    ...
                    isWaiting: isWaiting,
                    reportTitle: isNavigateFromServiceProvider
                        ? StringConstants.REPORT_CLIENT
                        : StringConstants.REPORT_SERVER_PROVIDER,
                    reportInstruction: isNavigateFromServiceProvider
                        ? StringConstants.REPORT_CLIENT_INSTRUCTIONS
                        : StringConstants.REPORT_SERVER_PROVIDER_INSTRUCTIONS,
                    nameFieldLabel: isNavigateFromServiceProvider
